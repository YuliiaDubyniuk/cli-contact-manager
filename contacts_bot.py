...
from book_records import ContactBook, Record, Phone, Name, Birthday
import utilities
from decorators import input_error


def main():
    """Handle address book through CLI"""
    book = ContactBook.load_data()
    ...
    while True:
        ...
        result = handle_command(book, command, args)
        if result == "exit":
            break
...
@input_error
def handle_command(book: ContactBook, command: str, args: list):
